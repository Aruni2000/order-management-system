...
// Tenant scoping for non-main admins is already applied via $roleBasedCondition
...
// NEW: Fetch users for the dropdown based on permissions
if ($is_main_admin == 1 && $current_user_role == 1) {
                ...
                <div class="table-wrapper">
                    <table class="orders-table">
                        ...
                        <tbody id="ordersTableBody">
                            ...
                            <?php else: ?>
                            <tr>
                                <td colspan="<?php echo ($is_main_admin == 1 && $_SESSION['role_id'] == 1) ? '10' : '9'; ?>" class="text-center"
