...
if (!($is_main_admin == 1 && $current_user_role == 1)) {
    // Non-super-admin users can only see their tenant's orders
...
<body>
    ...
    document.getElementById("syncRoyalBtn").addEventListener("click", function() {
        ...
        fetch('/orderhub_nextwave/dist/api/royalexpress_webhook.php')
            .then(response => response.json())
            .then(data => {
                btn.disabled = false;
    ...
    document.getElementById("syncTransexpBtn").addEventListener("click", function() {
        ...
        fetch('/orderhub_nextwave/dist/api/transexp_webhook.php')
            .then(response => response.json())
            .then(data => {
                btn.disabled = false;
    ...
    document.getElementById("syncKoombiyoBtn").addEventListener("click", function() {
        ...
        fetch('/orderhub_nextwave/dist/api/koombiyo_webhook.php')
            .then(response => response.json())
            .then(data => {
                btn.disabled = false;
