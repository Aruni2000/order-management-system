    ...
    function get_logo_with_fallback($conn, $tenant_id = null) {
        ...
        try {
            ...
            if ($data) {
                ...
                $result['debug'][] = "No active tenant data found in database.";
            }
...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    <div class="m-header tenant-header">
    ...
    <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-caption"><label>Order Management</label></li>
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link"><span class="pc-micon"> <i data-feather="shopping-cart"></i></span><span class="pc-mtext">Orders Management</span><span class="pc-arrow"><i class="ti ti-chevron-right"></i></span></a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="../orders/create_order.php">Create Order</a></li>
            <li class="pc-item"><a class="pc-link" href="../orders/all_orders.php">All Orders</a></li>
