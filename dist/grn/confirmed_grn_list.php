...
/**
 * Confirmed GRNs List
 * Standalone page displaying GRNs with status 'confirmed' (stock already added to inventory).
 * Modeled after the order management pages (e.g. complete_order_list.php).
...
// Count query - confirmed GRNs only
$countSql = "SELECT COUNT(*) as total FROM grn g LEFT JOIN suppliers s ON g.supplier_id = s.id LEFT JOIN tenants t ON g.tenant_id = t.tenant_id WHERE g.status = 'confirmed'";
// Main query - confirmed GRNs only
$sql = "SELECT g.*, s.name as supplier_name, t.company_name FROM grn g LEFT JOIN suppliers s ON g.supplier_id = s.id LEFT JOIN tenants t ON g.tenant_id = t.tenant_id WHERE g.status = 'confirmed'";
...
<head>
    <title>Confirmed GRNs | <?= htmlspecialchars($_SESSION['company_name'] ?? 'orderhub_nextwave') ?></title>
        ...
        <div class="pc-content">
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">Confirmed GRNs</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="main-content-wrapper">
                    ...
                    <form class="tracking-form" method="GET" action="">
                        ...
                        <div class="form-group">
                            <div class="button-group">
                                ...
                                <button type="button" class="search-btn" onclick="window.location.href='confirmed_grn_list.php'" style="background: #6c757d;">
                ...
                <div class="order-count-container">
                    ...
                    <div class="order-count-subtitle">Total Confirmed GRNs</div>
                </div>
