...
// Access Control: Only Main Admin (admin or store role) can create GRNs
...
<head>
    <title>Create GRN | <?= htmlspecialchars($_SESSION['company_name'] ?? 'orderhub_nextwave') ?></title>
    ...
    function addNewRow() {
        ...
        const row = `
            <tr class="line-item-row" data-index="${rowIndex}">
                ...
                <td>
                    <input type="text" name="items[${rowIndex}][batch_number]" class="form-control batch-number-input" value="" maxlength="30" readonly style="font-family: monospace; font-size: 12px; background: #f1f5f9;" placeholder="Batch Number">
                </td>
                <td class="line-subtotal">
                    Rs. 0.00
                </td>
